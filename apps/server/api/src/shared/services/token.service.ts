...
export class JwtBuilder<TPayload extends object = JwtPayload> {
    ...
    withAccessSecret(secret: string): this {
        this.accessSecret = secret; return this;
    }
    withRefreshSecret(secret: string): this {
        this.refreshSecret = secret; return this;
    }
    withAccessExpiresIn(expiresIn: string): this {
        this.accessExpiresIn = expiresIn; return this;
    }
    withRefreshExpiresIn(expiresIn: string): this {
        this.refreshExpiresIn = expiresIn; return this;
    }
    ...
    withOptions(options: Partial<SignOptions>): this {
        this.additionalOptions = { ...this.additionalOptions, ...options }; return this;
    }

    buildAccessToken(payload: TPayload): string {
        if (!this.accessSecret || !this.accessExpiresIn) throw new Error('ACCESS_CONFIG_MISSING');
    ...
    buildRefreshToken(payload: TPayload): string {
        if (!this.refreshSecret || !this.refreshExpiresIn) throw new Error('REFRESH_CONFIG_MISSING');
    ...
    buildPair(payload: TPayload, withRefresh = true): TokenPair {
        ...
        const refreshToken = withRefresh ? this.buildRefreshToken(payload) : undefined;
