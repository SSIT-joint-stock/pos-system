import { type OAuthAuthStrategy, type OAuthInitParams, type OAuthCallbackParams, type AuthResult } from '../../interfaces/auth.interface';
...
export class OAuthStrategy implements OAuthAuthStrategy {
    ...
    async init(params: OAuthInitParams): Promise<{ authUrl: string; state?: string }> {
