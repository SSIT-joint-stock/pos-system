...
import { Category, Product, Tag } from '@repo/design-system/types';
    ...
    <>
      ...
      >
          ...
          <div className="bg-white  p-5 rounded-md">
            ...
            <div className="space-y-5 mt-4">
              <div className="flex items-center gap-2">
                <Input
                  {...(productId
                    ? updateRegister('price', { valueAsNumber: true })
                ...
                <Input
                  {...(productId
                    ? updateRegister('cost', { valueAsNumber: true })
              ...
              <div className="space-y-3 mt-6 max-h-[400px] overflow-y-auto">
                {product.variant.map((variant) => (
                  <div
                    ...
                    key={variant?.id}
                    className="border-y border-y-gray-200 py-2.5 hover:bg-gray-50 transition-colors duration-300 cursor-pointer mt-4 flex items-center justify-between w-full"
                  >
                    <div className="flex flex-col gap-1.5">
                      <h3 className="text-sm font-semibold text-pos-blue-500">{variant?.name}</h3>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="px-6 py-4 text-sm text-nowrap text-gray-500 ">
                        <Input
                          {...register('quantity' as const, { valueAsNumber: true })}
                          type="number"
                          size="sm"
                          radius="sm"
        ...
        <div className="space-y-4">
          <div className="bg-white p-5 rounded-md ">
            <h2 className="text-base font-stretch-200% font-semibold text-gray-900">
              Ảnh sản phẩm (sử dụng image url)
            </h2>
            <Input
