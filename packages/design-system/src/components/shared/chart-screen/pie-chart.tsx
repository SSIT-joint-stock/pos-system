...
export function PieChart() {
  ...
  return (
    // <div ref={containerRef} className="bg-white w-full flex h-1/2  px-5 py-3 items-center gap-30 rounded-sm">
    ...
    //     </div>
    //   </div>
    <DonutChart h={200} size={200} withLabelsLine labelsType="value" withLabels data={data} />
    // </div>
  );
}
